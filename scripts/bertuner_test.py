...
classifier_opt = BERTuneClassifier(data_path="../test_data/question_data_qa_sep.csv", models_dir="../models/", text_feature="text_feature", target_col="target")
...
classifier_opt.optimize(n_trials=2, optimize_metric="avg_precision", study_name="bertclass_test")
## Here we train the model on these best parameters 
classifier_opt.train_final_model()